...
ka.config( function($routeProvider, $controllerProvider, $locationProvider){
	...
	.when('/posts', {
		templateUrl: 'templates/routes/posts.html',
		controller: 'posts'
	})
	.when('/:rtPostId', {
		templateUrl: 'templates/routes/postDetail.html',
...
ka.controller('posts', ['$scope','dataSvc', function($scope, dataSvc){
...
ka.controller('postDetail', ['$scope', '$routeParams', 'dataSvc', 'normalizeSvc',  function($scope, $routeParams, dataSvc, normalizeSvc){
...
ka.directive('singlePost',function(){
	return {
		...
		templateUrl : "templates/directives/postDetail.html"
	}
})
